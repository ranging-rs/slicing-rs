...
impl<'s, T: Eq + Clone, I: Indexer<T>, SL: Slice<'s, bool, N> + Clone, const N: Option<usize>> Clone
...
impl<'s, T: 's + Eq + Clone + Default + Sub<T>, SL: Slice<'s, bool, N>, const N: Option<usize>>
